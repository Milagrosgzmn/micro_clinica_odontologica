...
public class BD {
    ...
    private static final String SQL_DROP_CREATE_ODONTO = "DROP TABLE IF EXISTS ODONTOLOGOS; CREATE TABLE ODONTOLOGOS(ID INT AUTO_INCREMENT PRIMARY KEY, NOMBRE VARCHAR(100) NOT NULL, APELLIDO VARCHAR(100) NOT NULL,MATRICULA VARCHAR(100) NOT NULL)";
    private static final String prueba2 = " INSERT INTO ODONTOLOGOS (NOMBRE, APELLIDO, MATRICULA) VALUES ('Meredith', 'Grey', 'M12345'), ('Derek', 'Shepherd', 'N67890')";
...
//primero deberia llamar a la conexion
    ...
    try{
        ...
        statement.execute(SQL_DROP_CREATE_ODONTO);
        statement.execute(prueba);
        statement.execute(prueba2);
    ...
    //TODO: Medio manual esto, ver si usar el try con resources
